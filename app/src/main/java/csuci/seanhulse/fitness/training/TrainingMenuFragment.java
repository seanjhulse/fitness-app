...
public class TrainingMenuFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        previousTrainingExercise.setOnClickListener(v -> loadFragment(new PreviousExerciseFragment()));

        Button newTrainingExercise = view.findViewById(R.id.trainNewExerciseButton);
        newTrainingExercise.setOnClickListener(v -> loadFragment(new NewExerciseFragment()));
