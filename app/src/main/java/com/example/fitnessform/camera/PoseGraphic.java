...
public class PoseGraphic extends Graphic {
  ...
  private static final float IN_FRAME_LIKELIHOOD_TEXT_SIZE = 12.0f;
  private static final float STROKE_WIDTH = 10.0f;
  private static final float POSE_CLASSIFICATION_TEXT_SIZE = 12.0f;
  ...
  private final List<PoseLandmark> poseClassification;
  ...
  PoseGraphic(
    ...
    List<PoseLandmark> poseClassification) {
    super(overlay);
    this.pose = pose;
  ...
  public void draw(Canvas canvas) {
    ...
    for (int i = 0; i < poseClassification.size(); i++) {
      ...
      String landmarkType = com.example.fitnessform.PoseLandmark.valueOf(poseClassification.get(i).getLandmarkType()).name();
